# Denetim Kaydı — bulunan ve düzeltilen hatalar

*Bu dosya README'den ayrıldı: geliştirme günlüğü niteliğinde ve uzun.*
*Kısa özet için [OZET.md](OZET.md), yol haritası için [YOL_HARITASI.md](YOL_HARITASI.md).*

Sistem zaten kuruluydu; yapılan iş **denetimdi**. Her modül okundu ve gerçek
veriyle koşturuldu. Bulunanların çoğu "kod çöküyor" değil, **sessizce yanlış
sonuç üreten** türden — en tehlikelisi bu.
